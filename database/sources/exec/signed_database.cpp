...
void printUsage() {
  ...
  std::cerr << std::endl << "Usage: signed_database <n> <b> <o>" << std::endl << std::endl;
  ...
  std::cerr << " -----------------------------------------------------------------------" << std::endl;
  std::cerr << " |This program generates database files containing all possible signed |" << std::endl;
  std::cerr << " |permutations for the SWI-LS problem. In this problem, permutations   |" << std::endl;
  std::cerr << " |can be sorted by a sequence composed by any type of inversions. The  |" << std::endl;
  std::cerr << " |weight of the inversion are given by k + 1, where k  is given by the |" << std::endl;
  std::cerr << " |the absolute difference of the slice numbers of the inversion        |" << std::endl;
  std::cerr << " |extremities.                                                         |" << std::endl;
  std::cerr << " -----------------------------------------------------------------------" << std::endl << std::endl;

  std::cerr << " -----------------------------------------------------------------------" << std::endl;
  std::cerr << " |WARNING: This program may require huge amount of memory. For n=10, it|" << std::endl;
  std::cerr << " |requires approximately 300GB of RAM.                                 |" << std::endl;
  std::cerr << " -----------------------------------------------------------------------" << std::endl << std::endl;
